<cfcomponent extends="algid.inc.resource.base.view" output="false">
	<cffunction name="filterActive" access="public" returntype="string" output="false">
		...
		<cfset filterActive.addI18NBundle('plugins/user/i18n/inc/view', 'viewSchemeTag') />
	...
	<cffunction name="filter" access="public" returntype="string" output="false">
		...
		<!--- Add the resource bundle for the view --->
		<cfset filter.addI18NBundle('plugins/user/i18n/inc/view', 'viewSchemeTag') />
	...
	<cffunction name="list" access="public" returntype="string" output="false">
		...
		<!--- Add the resource bundle for the view --->
		<cfset datagrid.addI18NBundle('plugins/user/i18n/inc/view', 'viewSchemeTag') />
